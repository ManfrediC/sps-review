...
from _proceedings_text_autoresearch import (
    flatten_lines,
...
AUTORESEARCH_DEFAULT_RUN_DIR = REPO_ROOT / "qa" / "trimming" / "gold_standard" / "autoresearch" / "default_run"
TEXT_TRIMMED_DIR = AUTORESEARCH_DEFAULT_RUN_DIR / "text_trimmed"
TEXT_TRIM_REGISTRY_PATH = AUTORESEARCH_DEFAULT_RUN_DIR / "text_trim_registry.csv"
...
OUTPUT_PATH = AUTORESEARCH_DEFAULT_RUN_DIR / "proceedings_text_qc_registry.csv"
...
def refresh_artifact_registry(skip_refresh: bool) -> None:
    # Autoresearch outputs are non-canonical and must not refresh canonical registries.
    return
