...
heuristic, OpenAI, DeepSeek, and future architecture experiments.
"""
...
DEFAULT_OPTIMISATION_MATRIX: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "architecture_variant": "unit_ids_compact",
    ...
    {
        "name": "R1_deepseek_pro_gpt54_reviewed",
        "provider": "deepseek+openai",
        "model": "deepseek-v4-pro+gpt-5.4",
        "endpoint": "chat_completions+responses",
        "architecture_variant": "unit_ids_reviewed",
        "thinking_mode": "enabled",
        "reasoning_effort": "medium",
        "prompt_variant": "featured_units_patch_v1",
        "notes": "Universal GPT-5.4 reviewer-patcher diagnostic benchmark.",
    },
]
